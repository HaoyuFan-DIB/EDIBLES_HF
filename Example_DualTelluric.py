# The aim of this script is to fits the six telluric lines between 7670 AA and 7685AA
...
import edibles_Working.edibles_model as eM
import edibles_Working.edibles_spectrum as eS
import numpy as np
...
# a = sp.raiseParameter(module="Telluric1") will give you everything within "Telluric1"
# b = sp.raiseParameter(module="Telluric2", par="lam") will give you the lam_0 of Telluric2
